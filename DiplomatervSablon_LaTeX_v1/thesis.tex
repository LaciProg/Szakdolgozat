...
\newcommand{\vikszerzoVezeteknev}{Muzslai}
...
\newcommand{\vikcim}{Kvíz generálási lehetőségek vizsgálata egy fullstack megoldás megvalósítása keretében} % Cím
...
\include{content/introduction}      % Ellenőrizve
\include{content/specifiation}      % Ellenőrizve
\include{content/search}            % Ellenőrizve
\include{content/architecture}      
\include{content/details}           
\include{content/future}            % Ellenőrizve
\include{content/summary}           % Ellenőrizve
