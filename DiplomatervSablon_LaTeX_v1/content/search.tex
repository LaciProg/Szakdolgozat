...
Az egyetlen fontosabb rész amit kihagytam, az maga a Compose deklaratív UI toolkit (\refstruc{sec:JetpackCompose}), ami a Compose Multiplatformot alkotja.
...
Ezt az előző félévben készítettem el. Teljesen egészében Kotlin nyelv felhasználásával. A HTTP kommunikáció megvalósítsához a már korábban \refstruc{sec:Ktor}-ban bemutatott Ktor-t használtam.
Itt a szerver oldali funkcionaliítása került előtérbe. A szerilizáció itt is a \refstruc{sec:KotlinX}-ban leírtak szerint történt.
...
Mind az adatbázis, mind a REST API egy-egy Docker-konténerben fut egy viruális gépen, így biztosítva a folyamatos elérhetőséget.
...
Egy korábbi KMP ViewModel alternatíva a moko viewmodel (Mobile Kotlin Model-View-ViewModel architecture) volt, de ennél kényelmesebb az Androidos.
...
A kiválásztás során számos szempontot figyelembe vettem. Fontos volt a tanulási lehetőség a témából, lehetőleg olyan módon, hogy azt később is tudjam kamatoztatni.
